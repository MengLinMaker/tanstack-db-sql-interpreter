...
export class StoolapDB {
  __destroy_into_raw() {
    ...
    this.__wbg_ptr = 0
    StoolapDBFinalization.unregister(this)
    return ptr
  }
  free() {
    const ptr = this.__destroy_into_raw()
    wasm.__wbg_stoolapdb_free(ptr, 0)
  }
  /**
  ...
  execute(sql) {
    ...
    try {
      ...
      const ret = wasm.stoolapdb_execute(this.__wbg_ptr, ptr0, len0)
      deferred2_0 = ret[0]
      deferred2_1 = ret[1]
  ...
  execute_batch(sql) {
    ...
    try {
      const ptr0 = passStringToWasm0(sql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
      const len0 = WASM_VECTOR_LEN
      const ret = wasm.stoolapdb_execute_batch(this.__wbg_ptr, ptr0, len0)
      deferred2_0 = ret[0]
      deferred2_1 = ret[1]
      return getStringFromWasm0(ret[0], ret[1])
    } finally {
   ...
   */
  constructor() {
    const ret = wasm.stoolapdb_new()
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1])
    }
    this.__wbg_ptr = ret[0] >>> 0
    StoolapDBFinalization.register(this, this.__wbg_ptr, this)
    return this
  }
  /**
  ...
  version() {
    ...
    let deferred1_1
    try {
      const ret = wasm.stoolapdb_version(this.__wbg_ptr)
      deferred1_0 = ret[0]
      deferred1_1 = ret[1]
      return getStringFromWasm0(ret[0], ret[1])
    } finally {
...
if (Symbol.dispose) StoolapDB.prototype[Symbol.dispose] = StoolapDB.prototype.free
...
function __wbg_get_imports() {
  ...
  return {
    __proto__: null,
    "./stoolap_bg.js": import0,
  }
}

const StoolapDBFinalization = (typeof FinalizationRegistry === 'undefined')
  ? { register: () => { }, unregister: () => { } }
  : new FinalizationRegistry(ptr => wasm.__wbg_stoolapdb_free(ptr >>> 0, 1))
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === undefined) {
    module_or_path = new URL('stoolap_bg.wasm', import.meta.url)
  }
  const imports = __wbg_get_imports()
